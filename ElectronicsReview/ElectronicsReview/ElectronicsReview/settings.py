"""
Django settings for ElectronicsReview project.
...
SECRET_KEY = 'django-insecure-vrc%cl1mnttb(l@e9eq$*kw%eth^rd^@=4-yk6ryf8ps0zwsd-'
...
INSTALLED_APPS = [
    'ElectronicsReviewApp.apps.ElectronicsreviewappConfig',
...
ROOT_URLCONF = 'ElectronicsReview.urls'
